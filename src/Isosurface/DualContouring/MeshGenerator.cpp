...
// {
//     glm::ivec3 coord = _index.Decode(index);
...
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y - 1, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y - 1, coord.z - 1))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y, coord.z - 1))] = true;
//     }
//     else
//     {
...
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x - 1, coord.y, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x - 1, coord.y, coord.z - 1))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y, coord.z - 1))] = true;
//     }
//     else
//     {
...
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x - 1, coord.y, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x - 1, coord.y - 1, coord.z))] = true;
//         _cubeCheck[_index.Encode(glm::ivec3(coord.x, coord.y - 1, coord.z))] = true;
//     }
//     else
//     {
