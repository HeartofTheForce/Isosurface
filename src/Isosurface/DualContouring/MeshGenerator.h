...
class MeshGenerator
{
    ...
    inline void PushEdge(MeshCpu& meshCpu,
                                        const int& offset,
                                        const float& dir,
    ...
    inline void AggregateEdge(const EdgeMap& edgeMap, const glm::ivec3& coord, glm::vec3& sum, int& cnt);
  ...
  public:
    ...
    MeshGenerator(std::shared_ptr<CachedSDF> cachedSDF)
        : _cachedSDF(cachedSDF),
          Index(_cachedSDF->Index.Size - glm::ivec3(1)),
          _edgeMapX(EdgeMap{glm::ivec3(Index.Size.x, _cachedSDF->Index.Size.y, _cachedSDF->Index.Size.z)}),
          _edgeMapY(EdgeMap{glm::ivec3(_cachedSDF->Index.Size.x, Index.Size.y, _cachedSDF->Index.Size.z)}),
          _edgeMapZ(EdgeMap{glm::ivec3(_cachedSDF->Index.Size.x, _cachedSDF->Index.Size.y, Index.Size.z)}),
